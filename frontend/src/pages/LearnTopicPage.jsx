...
import { LinkedListStory } from '@/components/story/LinkedListStory'
    ...
    <div className="min-h-screen bg-[#07111C] relative flex flex-col lg:flex-row">
      ...
      <aside className="w-full lg:w-80 border-r border-white/5 bg-[#0A0F1E] flex flex-col flex-shrink-0">
        <div className="p-6">
          ...
          <div className="mb-10">
            <span className={`text-[10px] font-bold uppercase tracking-widest px-2.5 py-1 rounded-md bg-white/5 border border-white/10 ${topic.difficulty === 'Easy' ? 'text-emerald-400' : topic.difficulty === 'Medium' ? 'text-amber-400' : 'text-rose-400'
          ...
          <nav className="relative space-y-2">
            {/* Vertical Line */}
            <div className="absolute left-[31px] top-4 bottom-4 w-0.5 bg-white/5" />
            ...
            {steps.map((s, idx) => {
              ...
              return (
                <button
                  ...
                  className={`w-full relative flex items-center gap-4 p-3 rounded-2xl transition-all duration-300 group ${isActive ? 'bg-[#7B61FF]/10 ring-1 ring-[#7B61FF]/30' : 'hover:bg-white/5'
                    }`}
                >
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center z-10 transition-all duration-500 ${isPast ? 'bg-[#10B981] shadow-[0_0_15px_rgba(16,185,129,0.3)]' :
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                {activeStepId === 'info' && topicId === 'linked-list' && (
                  <LinkedListStory
                ...
                {activeStepId === 'visualize' && (
                  <div className="space-y-8">
                    ...
                    <div className="bg-[#0c1a27] border border-white/5 rounded-3xl p-8 shadow-2xl relative group">
                      ...
                      <Suspense fallback={<div className="h-64 flex items-center justify-center text-[#94A3B8]">Loading visualization...</div>}>
